        ...
        @else
            <div class="flex flex-col gap-5">
                ...
                @foreach($cartItems as $item)
                    ...
                    <div class="w-full flex sm:flex-row xs:flex-col relative shadow-custom bg-white p-4 rounded-2xl">
                        <div class="sm:w-1/2 xs:w-full flex items-center gap-3">
                        ...
                        <div class="sm:w-1/2 xs:w-full grid grid-cols-3">
                            <div
