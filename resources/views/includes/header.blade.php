        ...
        <nav class="grid grid-cols-3 py-6">
            <div class="flex items-center justify-start">
                <a href="/" class="flex items-center gap-2">
                    ...
                    <p class="text-black text-xl sm:block xs:hidden">IT-CAFE</p>
                </a>
{{--                <div class="text-sm">Доступна доставка<br>по Казани</div>--}}
            ...
            <div class="flex gap-4 justify-center items-center text-black">
                <div class="w-full m-auto lg:max-w-[25rem] sm:max-w-[15rem] sx:max-w-[10rem]">
                    <form id="search-form" method="get" class="relative bg-f9f9f9 border-black border-opacity-5 border-solid border-0.5 w-full">
                        <input id="search-input" type="text" placeholder="Поиск" name="query" class="border border-gray-30000 shadow-custom pl-5 text-black lg:py-2 sx:py-1 rounded-2xl outline-none lg:max-w-[25rem] sm:max-w-[15rem] sx:max-w-[10rem] w-full header-input-background">
                    ...
                    <div id="search-results" class="mt-4 hidden bg-white shadow-lg rounded-lg p-4 absolute z-30 w-full max-w-lg">
