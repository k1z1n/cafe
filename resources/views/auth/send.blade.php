    ...
    <div
        ...
        <form id="sendSmsForm" method="post" action="{{ route('auth.send') }}">
            ...
            <input type="tel" id="phoneNumber" name="phoneNumber" required
                   class="tel mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-[#3a86ff] sm:text-sm">
            ...
            <button id="sendSms" type="submit"
                    class="mt-4 w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#E2E8F0FF] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
